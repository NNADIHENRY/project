...
import com.example.henry.myprojectmaterials.utils.Utils;
...
public class ContactPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgfacebook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://web.facebook.com/myprojectmaterials"));
        ...
        imgtwitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/myprojectmaterials/"));
                startActivity(browserIntent);
    ...
    private void validate() {
      ...
      if (utils.isNetworkAvailable(getApplicationContext())){
          ...
          if (!utils.isValidEmail(getApplicationContext(),email)) {
              ...
              String to = "nnadihenry92@gmail.com";
